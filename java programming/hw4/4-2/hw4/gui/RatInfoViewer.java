...
public class RatInfoViewer extends JPanel {
	...
	public RatInfoViewer() {
		...
		// TODO (handle the layout)

		setLayout(new BorderLayout());//use borderlayout
		add(fieldPanel,BorderLayout.WEST);//add fieldPanel to the left
		add(valuePanel,BorderLayout.CENTER);//add valuePanel to the right
	...
	public void setPharmacyInfo(Pharmacy pharmacy) {//get the relative data from pharmacy
		// TODO
		...
		ratNumberValue.setText(Integer.toString(pharmacy.getNumberOfRapidAntigenTests()));
